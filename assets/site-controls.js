...
// Client reviews — interior pages (about.html, etc.)
    ...
    // ============================================================
    // 5 new services (functional-training, fitness, hammock-yoga, nutrition-tracking, form-check)
    // ============================================================
    "Functional Training | Eylem Tarhan Personal Training": { tr: "Fonksiyonel Antrenman | Eylem Tarhan Kişisel Antrenman", sr: "Funkcionalni Trening | Eylem Tarhan Personal Training", ru: "Функциональный тренинг | Eylem Tarhan Personal Training" },
    "FUNCTIONAL TRAINING": { tr: "FONKSİYONEL ANTRENMAN", sr: "FUNKCIONALNI TRENING", ru: "ФУНКЦИОНАЛЬНЫЙ ТРЕНИНГ" },
    "What is Functional Training?": { tr: "Fonksiyonel Antrenman Nedir?", sr: "Šta je Funkcionalni Trening?", ru: "Что такое функциональный тренинг?" },
    "Functional training builds strength that translates directly into real life \u2014 lifting groceries, climbing stairs, playing with your kids, moving without pain. We use compound movements, kettlebells, resistance bands, and bodyweight exercises that train multiple muscle groups simultaneously, improving coordination, balance, and stability. Whether you are an athlete prepping for sport or a desk worker fixing years of stiffness, every session is built to make your body move better in everyday life.": { tr: "Fonksiyonel antrenman, salonda kazandığın gücü doğrudan gerçek hayata taşıyan tek yöntemdir — alışveriş torbalarını taşımak, merdiven çıkmak, çocuğunla oynamak, ağrısız hareket etmek. Kettlebell, direnç bandı, kendi vücut ağırlığın ve compound (bileşik) hareketlerle birden fazla kas grubunu aynı anda çalıştırarak koordinasyonunu, dengeni ve stabiliteni geliştiriyoruz. İster spora hazırlanan bir sporcu ol, ister masa başında yıllardır oluşan tutukluğu çözmek isteyen biri — her seans bedeninin günlük hayatta daha iyi hareket etmesi için tasarlanır.", sr: "Funkcionalni trening gradi snagu koja se direktno prenosi u svakodnevni život — nošenje namirnica, penjanje stepenicama, igranje sa decom, kretanje bez bola. Koristimo kompleksne pokrete, kettlebellove, gume i vežbe sa sopstvenom težinom koje istovremeno treniraju više mišićnih grupa, poboljšavajući koordinaciju, ravnotežu i stabilnost. Bio si sportista koji se priprema za sezonu ili kancelarijski radnik koji rešava godinama nakupljenu krutinu — svaki trening pravi tako da telo bolje funkcioniše u stvarnom životu.", ru: "Функциональный тренинг строит силу, которая напрямую переносится в реальную жизнь — носить продукты, подниматься по лестнице, играть с детьми, двигаться без боли. Мы используем многосуставные движения, гири, эспандеры и упражнения с собственным весом, которые одновременно тренируют несколько групп мышц, улучшая координацию, баланс и стабильность. Будь то спортсмен в подготовке или офисный работник, борющийся с годами скованности — каждое занятие построено так, чтобы тело двигалось лучше в повседневной жизни." },
    "MOVE BETTER IN EVERYDAY LIFE:": { tr: "GÜNLÜK HAYATTA DAHA İYİ HAREKET ET:", sr: "BOLJE SE KREĆI U SVAKODNEVNICI:", ru: "ДВИГАЙСЯ ЛУЧШЕ КАЖДЫЙ ДЕНЬ:" },
    "Every drill is engineered to upgrade the patterns you already use a hundred times a day \u2014 squatting, lifting, twisting, reaching, walking up stairs. The result: less effort, less stiffness, and a body that just works the way it should.": { tr: "Her egzersiz, gün içinde yüzlerce kez kullandığın hareket kalıplarını geliştirmek için tasarlanmıştır — çömelmek, kaldırmak, dönmek, uzanmak, merdiven çıkmak. Sonuç: daha az çaba, daha az tutukluk ve olması gerektiği gibi çalışan bir vücut.", sr: "Svaka vežba je smišljena da unapredi obrasce koje već koristiš stotinu puta dnevno — čučanj, dizanje, rotacija, posezanje, penjanje stepenicama. Rezultat: manje napora, manje krutine i telo koje radi kako treba.", ru: "Каждое упражнение разработано, чтобы улучшить паттерны, которые ты уже используешь сотни раз в день — приседания, подъёмы, повороты, дотягивания, ходьба по лестнице. Результат: меньше усилий, меньше скованности, и тело, которое работает так, как должно." },
    "CORE STABILITY AND BALANCE:": { tr: "KORE STABİLİTESİ VE DENGE:", sr: "STABILNOST CORE-A I RAVNOTEŽA:", ru: "СТАБИЛЬНОСТЬ КОРА И БАЛАНС:" },
    "Functional work trains the deep stabilizers your phone-and-chair life forgot. Stronger core, sharper proprioception, better balance \u2014 translation: no more rolled ankles, tweaked backs, or mystery aches.": { tr: "Fonksiyonel çalışma, telefon-sandalye hayatının unuttuğu derin stabilizör kasları çalıştırır. Daha güçlü kore, daha keskin propriosepsiyon, daha iyi denge — yani: artık burkulan bilekler, çekilen sırtlar veya nedeni bilinmeyen ağrılar yok.", sr: "Funkcionalni rad trenira duboke stabilizatore koje je tvoj telefon-i-stolica život zaboravio. Jači core, oštriji osećaj za telo, bolja ravnoteža — drugim rečima: više nema iskrenutih članaka, bolnih leđa ni misterioznih bolova.", ru: "Функциональная работа тренирует глубокие стабилизаторы, о которых забыла твоя сидячая жизнь со смартфоном. Более сильный кор, точная проприоцепция, лучший баланс — переводя: никаких подвернутых лодыжек, прострелов в спине или загадочных болей." },
    "INJURY PREVENTION AND RECOVERY:": { tr: "SAKATLIK ÖNLEME VE TOPARLANMA:", sr: "PREVENCIJA POVREDA I OPORAVAK:", ru: "ПРОФИЛАКТИКА ТРАВМ И ВОССТАНОВЛЕНИЕ:" },
    "Multi-joint, multi-plane movement bulletproofs your knees, shoulders, hips, and lower back. Whether you are coming back from injury or just want to stay out of one, functional training is the smartest long-term insurance.": { tr: "Çoklu eklem ve çoklu düzlemde hareket; dizlerini, omuzlarını, kalçanı ve belini sağlamlaştırır. İster bir sakatlıktan dönüyor ol, ister sakatlanmak istemiyor — fonksiyonel antrenman, uzun vadeli en akıllı sigortandır.", sr: "Pokret kroz više zglobova i ravni štiti kolena, ramena, kukove i donji deo leđa. Vraćaš se od povrede ili jednostavno želiš da je nikad ne dobiješ — funkcionalni trening je najpametnija dugoročna polisa osiguranja.", ru: "Многосуставное, многоплоскостное движение делает твои колени, плечи, бёдра и поясницу пуленепробиваемыми. Возвращаешься после травмы или просто не хочешь её получать — функциональный тренинг это самая разумная долгосрочная страховка." },
    "CARRY-OVER TO SPORT AND PERFORMANCE:": { tr: "SPORA VE PERFORMANSA AKTARIM:", sr: "PRENOS NA SPORT I PERFORMANSE:", ru: "ПЕРЕНОС В СПОРТ И ПРОИЗВОДИТЕЛЬНОСТЬ:" },
    "Football, tennis, hiking, dance, jiu-jitsu \u2014 whatever you love doing, functional training makes you better at it. Faster, more explosive, more agile, with the conditioning to keep going when others fade.": { tr: "Futbol, tenis, doğa yürüyüşü, dans, jiu-jitsu — ne yapmayı seviyorsan, fonksiyonel antrenman seni o işte daha iyi yapar. Daha hızlı, daha patlayıcı, daha çevik ve diğerleri yorulduğunda devam edecek kondisyona sahip.", sr: "Fudbal, tenis, planinarenje, ples, jiu-jitsu — šta god voliš da radiš, funkcionalni trening te čini boljim u tome. Brži, eksplozivniji, agilniji, sa kondicijom koja te drži kad drugi popuste.", ru: "Футбол, теннис, треккинг, танцы, джиу-джитсу — что бы ты ни любил, функциональный тренинг делает тебя лучше в этом. Быстрее, взрывнее, ловчее, с выносливостью, когда другие сдают." },
    "Fitness | Eylem Tarhan Personal Training": { tr: "Fitness | Eylem Tarhan Kişisel Antrenman", sr: "Fitness | Eylem Tarhan Personal Training", ru: "Фитнес | Eylem Tarhan Personal Training" },
    "What is Fitness Training?": { tr: "Fitness Antrenmanı Nedir?", sr: "Šta je Fitness Trening?", ru: "Что такое фитнес-тренировки?" },
    "Fitness is the all-rounder \u2014 cardio, strength, flexibility and endurance combined into one program built to upgrade every system in your body at once. We mix HIIT bursts, weighted circuits, mobility work and conditioning so you burn fat, build muscle, breathe easier and move with confidence. No matter your starting point \u2014 total beginner or returning athlete \u2014 your program flexes around your weekly schedule, energy and goals so you actually keep showing up.": { tr: "Fitness, vücudundaki her sistemi tek antrenmanda geliştiren çok yönlü bir programdır — kardiyo, kuvvet, esneklik, dayanıklılık. HIIT setleri, ağırlıklı sirkülasyon antrenmanları, mobilite çalışmaları ve kondisyon hareketlerini harmanlıyoruz; böylece yağ yakıyor, kas yapıyor, daha kolay nefes alıyor ve daha kendine güvenli hareket ediyorsun. Sıfırdan başlayan da olsan, eski kondisyonuna dönen sporcu da olsan, programın haftalık takvimine, enerjine ve hedeflerine göre şekillenir; gerçekten devam etmen için.", sr: "Fitness je sveobuhvatan pristup — kardio, snaga, fleksibilnost i izdržljivost spojeni u jedan program koji unapređuje svaki sistem u tvom telu odjednom. Mešamo HIIT sekvence, opterećene kružne treninge, mobilnost i kondicioning, tako da sagoreš mast, izgradiš mišiće, lakše dišeš i krećeš se sa samopouzdanjem. Bez obzira gde si — apsolutni početnik ili sportista u povratku — program se prilagođava tvojoj nedelji, energiji i ciljevima, da bi nastavio da dolaziš.", ru: "Фитнес — это универсальный подход: кардио, сила, гибкость и выносливость в одной программе, которая улучшает все системы тела сразу. Мы сочетаем HIIT-серии, силовые круговые, работу над мобильностью и кондиционированием — ты сжигаешь жир, строишь мышцы, легче дышишь и двигаешься с уверенностью. Какой бы ни была точка старта — полный новичок или возвращающийся атлет — программа гибко подстраивается под твой график, энергию и цели, чтобы ты действительно продолжал ходить." },
    "TOTAL-BODY CONDITIONING:": { tr: "TÜM VÜCUT KONDİSYONU:", sr: "KONDICIONING CELOG TELA:", ru: "ПОЛНАЯ ФИЗИЧЕСКАЯ ПОДГОТОВКА:" },
    "Cardio, strength, mobility and core all in one structured plan. Nothing gets neglected \u2014 every system in your body gets the stimulus it needs to adapt, week after week.": { tr: "Kardiyo, kuvvet, mobilite ve kore tek bir yapılandırılmış planda. Hiçbir şey ihmal edilmez — vücudundaki her sistem haftadan haftaya adapte olması için ihtiyacı olan uyarıyı alır.", sr: "Kardio, snaga, mobilnost i core u jednom planu. Ništa se ne zanemaruje — svaki sistem u tvom telu dobija stimulus potreban za adaptaciju, nedelju za nedeljom.", ru: "Кардио, сила, мобильность и кор — всё в одном структурированном плане. Ничто не упускается — каждая система в твоём теле получает стимул для адаптации, неделя за неделей." },
    "FAT LOSS THAT STICKS:": { tr: "KALICI YAĞ KAYBI:", sr: "TRAJAN GUBITAK MASTI:", ru: "ЖИРОСЖИГАНИЕ, КОТОРОЕ ОСТАЁТСЯ:" },
    "Smart programming combines metabolic conditioning with progressive resistance work, so you lose fat without losing the muscle that keeps your metabolism high. The change you see actually stays.": { tr: "Akıllı programlama, metabolik kondisyonu kademeli direnç çalışmasıyla birleştirir; böylece metabolizmanı yüksek tutan kası kaybetmeden yağ yakarsın. Gördüğün değişim gerçekten kalıcı olur.", sr: "Pametno programiranje kombinuje metabolički kondicioning sa progresivnim radom sa otporom, tako da gubiš mast bez gubitka mišića koji ti drže metabolizam visokim. Promena koju vidiš zaista ostaje.", ru: "Грамотное программирование сочетает метаболический кондишн с прогрессивной силовой работой — ты теряешь жир без потери мышц, которые держат метаболизм высоким. То, что ты видишь, действительно остаётся." },
    "ENERGY THAT LASTS ALL DAY:": { tr: "TÜM GÜN SÜREN ENERJİ:", sr: "ENERGIJA KOJA TRAJE CEO DAN:", ru: "ЭНЕРГИЯ НА ВЕСЬ ДЕНЬ:" },
    "Better aerobic capacity, stronger lungs, sharper recovery. The 3pm slump disappears, you sleep better, and the gym stops feeling like another item on the to-do list.": { tr: "Daha iyi aerobik kapasite, daha güçlü akciğerler, daha keskin toparlanma. Öğleden sonraki halsizlik kaybolur, daha iyi uyursun ve salon, yapılacaklar listesindeki başka bir maddeye benzemeyi bırakır.", sr: "Bolji aerobni kapacitet, jača pluća, oštriji oporavak. Popodnevni pad nestaje, bolje spavaš, a teretana prestaje da bude još jedna stavka na listi obaveza.", ru: "Лучшая аэробная ёмкость, более сильные лёгкие, чёткое восстановление. Послеобеденный спад исчезает, ты лучше спишь, а зал перестаёт быть очередным пунктом в списке дел." },
    "A BODY THAT MOVES WELL AT ANY AGE:": { tr: "HER YAŞTA İYİ HAREKET EDEN BİR VÜCUT:", sr: "TELO KOJE SE DOBRO KREĆE U SVAKOM DOBU:", ru: "ТЕЛО, КОТОРОЕ ХОРОШО ДВИГАЕТСЯ В ЛЮБОМ ВОЗРАСТЕ:" },
    "Mobility built in from the first session. Strong joints, full range of motion, posture that holds \u2014 so you keep training, hiking, lifting your kids, and feeling young for decades, not months.": { tr: "İlk seanstan itibaren mobilite işin içinde. Güçlü eklemler, tam hareket aralığı, korunan postür — böylece on yıllar boyunca antrenman yapmaya, doğa yürüyüşü yapmaya, çocuklarını kucağına almaya ve genç hissetmeye devam edersin.", sr: "Mobilnost ugrađena od prvog treninga. Jaki zglobovi, pun raspon pokreta, postura koja se drži — tako da nastavljaš da treniraš, planinariš, dižeš decu i osećaš se mlado decenijama, ne mesecima.", ru: "Мобильность встроена с первой тренировки. Сильные суставы, полная амплитуда движения, осанка, которая держится — ты продолжаешь тренироваться, ходить в горы, поднимать своих детей и чувствовать себя молодым десятилетиями, а не месяцами." },
    "Hammock Yoga | Eylem Tarhan Personal Training": { tr: "Hamak Yoga | Eylem Tarhan Kişisel Antrenman", sr: "Hamak Joga | Eylem Tarhan Personal Training", ru: "Гамак-йога | Eylem Tarhan Personal Training" },
    "HAMMOCK YOGA": { tr: "HAMAK YOGA", sr: "HAMAK JOGA", ru: "ГАМАК-ЙОГА" },
    "What is Hammock Yoga?": { tr: "Hamak Yoga Nedir?", sr: "Šta je Hamak Joga?", ru: "Что такое гамак-йога?" },
    "Hammock yoga (aerial yoga) lets gravity do the work \u2014 you suspend in soft fabric hammocks to deepen stretches, decompress your spine and unlock postures that are impossible on a mat alone. Sessions blend breathwork, traditional yoga shapes and gentle inversions that release pressure on the neck, lower back and joints. It is both a strength practice and a recovery tool \u2014 perfect after long desk days, hard training weeks, or whenever you need to feel taller, looser and lighter.": { tr: "Hamak yoga (aerial yoga), yer çekiminden faydalanarak yumuşak kumaş hamaklarda asılarak yapılan benzersiz bir yoga pratiğidir — esnemeleri derinleştirir, omurganı dekomprese eder ve mat üzerinde imkansız olan postürleri açar. Seanslar nefes çalışmasını, klasik yoga duruşlarını ve nazik ters duruşları birleştirir; böylece boyun, bel ve eklemlerdeki baskı azalır. Hem kuvvet pratiği hem toparlanma aracıdır — uzun masa başı günlerden, yorucu antrenman haftalarından sonra ya da kendini daha uzun, gevşek ve hafif hissetmek istediğin her an için ideal.", sr: "Hamak joga (aerijalna joga) pušta gravitaciju da radi posao — visiš u mekim platnenim hamacima da produbiš istezanja, dekompresuješ kičmu i otključaš poze koje su na strunjači nemoguće. Sesije spajaju rad sa dahom, klasične jogijske oblike i nežne inverzije koje oslobađaju pritisak sa vrata, donjih leđa i zglobova. To je istovremeno trening snage i sredstvo za oporavak — savršeno posle dugih radnih dana, teških trening nedelja, ili kad god ti treba da se osećaš viši, opušteniji i lakši.", ru: "Гамак-йога (аэрийога) использует силу тяжести в твою пользу — ты подвешиваешься в мягких тканевых гамаках, углубляя растяжку, разгружая позвоночник и открывая позы, невозможные на коврике. Занятия сочетают дыхательные практики, классические йоговские формы и мягкие перевёрнутые позы, снимая давление с шеи, поясницы и суставов. Это одновременно практика силы и инструмент восстановления — идеально после долгих офисных дней, тяжёлых недель тренировок или когда хочется почувствовать себя выше, расслабленнее и легче." },
    "SPINAL DECOMPRESSION AND POSTURE:": { tr: "OMURGA DEKOMPRESYONU VE POSTÜR:", sr: "DEKOMPRESIJA KIČME I POSTURA:", ru: "ДЕКОМПРЕССИЯ ПОЗВОНОЧНИКА И ОСАНКА:" },
    "Hanging inversions create traction along your spine that is impossible to recreate on the floor. Compressed discs get a chance to breathe, posture lifts naturally, and chronic neck and back stiffness eases out within weeks.": { tr: "Hamakta asılı kalmak, omurganda zeminde mümkün olmayan bir traksiyon yaratır. Sıkışmış diskler nefes alma şansı bulur, postür doğal olarak yükselir ve kronik boyun ile sırt tutukluğu birkaç hafta içinde çözülür.", sr: "Visenje u inverzijama stvara trakciju duž kičme koju je nemoguće dobiti na podu. Stisnuti diskovi dobijaju priliku da dišu, postura se prirodno podiže, a hronična ukočenost vrata i leđa popušta u par nedelja.", ru: "Висение в инверсиях создаёт тракцию вдоль позвоночника, которую невозможно воспроизвести на полу. Сдавленные диски получают возможность дышать, осанка естественно поднимается, а хроническая скованность шеи и спины уходит за пару недель." },
    "DEEPER FLEXIBILITY WITHOUT STRAIN:": { tr: "ZORLAMADAN DAHA DERİN ESNEKLİK:", sr: "DUBLJA FLEKSIBILNOST BEZ PRINUDE:", ru: "БОЛЕЕ ГЛУБОКАЯ ГИБКОСТЬ БЕЗ НАПРЯЖЕНИЯ:" },
    "The hammock supports your weight so you can settle into stretches deeper, longer and safer than on a mat. Hips open, hamstrings release, shoulders loosen \u2014 without forcing or risking strain.": { tr: "Hamak vücut ağırlığını taşır, böylece esnemelere mat üzerindekinden daha derin, daha uzun ve daha güvenli yerleşebilirsin. Kalçalar açılır, hamstringler gevşer, omuzlar yumuşar — zorlamadan ve incinme riski olmadan.", sr: "Hamak nosi tvoju težinu pa možeš da se smestiš u istezanja dublje, duže i bezbednije nego na strunjači. Kukovi se otvaraju, zadnja loža popušta, ramena se opuštaju — bez forsiranja i rizika od povrede.", ru: "Гамак поддерживает твой вес, так что ты можешь погружаться в растяжку глубже, дольше и безопаснее, чем на коврике. Бёдра открываются, задняя поверхность бедра расслабляется, плечи отпускают — без насилия и риска травмы." },
    "CORE STRENGTH AND BODY CONTROL:": { tr: "KORE GÜCÜ VE VÜCUT KONTROLÜ:", sr: "SNAGA CORE-A I KONTROLA TELA:", ru: "СИЛА КОРА И КОНТРОЛЬ ТЕЛА:" },
    "Every transition in the hammock recruits deep core stabilizers, shoulders and grip. The result is a stronger midsection, better balance, and the kind of body awareness that carries into everything you do.": { tr: "Hamaktaki her geçiş; derin kore stabilizörlerini, omuzları ve kavramayı çalıştırır. Sonuç: daha güçlü bir orta gövde, daha iyi denge ve yaptığın her şeye taşınan bir vücut farkındalığı.", sr: "Svaki prelaz u hamaku angažuje duboke stabilizatore core-a, ramena i hvat. Rezultat: jači sredinji deo tela, bolja ravnoteža i ona vrsta telesne svesti koja se prenosi na sve što radiš.", ru: "Каждый переход в гамаке задействует глубокие стабилизаторы кора, плечи и хват. Результат: более сильная середина тела, лучший баланс и осознанность тела, которая переносится во всё, что ты делаешь." },
    "STRESS RELEASE AND BETTER SLEEP:": { tr: "STRES BOŞALTMA VE DAHA İYİ UYKU:", sr: "OSLOBAĐANJE OD STRESA I BOLJI SAN:", ru: "СНЯТИЕ СТРЕССА И ЛУЧШИЙ СОН:" },
    "Inversions activate the parasympathetic nervous system \u2014 the body shifts out of stress mode and into recovery. Most clients report deeper sleep, calmer mornings and noticeably less anxiety after a few sessions.": { tr: "Ters duruşlar parasempatik sinir sistemini aktive eder — vücut stres modundan toparlanma moduna geçer. Çoğu danışan birkaç seanstan sonra daha derin uyku, daha sakin sabahlar ve belirgin şekilde azalmış kaygı bildirir.", sr: "Inverzije aktiviraju parasimpatički nervni sistem — telo izlazi iz stres-moda i ulazi u oporavak. Većina klijenata posle par sesija prijavljuje dublji san, mirnija jutra i primetno manje anksioznosti.", ru: "Инверсии активируют парасимпатическую нервную систему — тело выходит из режима стресса в режим восстановления. Большинство клиентов после нескольких занятий отмечают более глубокий сон, спокойные утра и заметно меньше тревоги." },
    "Nutrition Tracking | Eylem Tarhan Personal Training": { tr: "Beslenme Takibi | Eylem Tarhan Kişisel Antrenman", sr: "Praćenje Ishrane | Eylem Tarhan Personal Training", ru: "Контроль питания | Eylem Tarhan Personal Training" },
    "NUTRITION TRACKING": { tr: "BESLENME TAKİBİ", sr: "PRAĆENJE ISHRANE", ru: "КОНТРОЛЬ ПИТАНИЯ" },
    "What is Nutrition Tracking?": { tr: "Beslenme Takibi Nedir?", sr: "Šta je Praćenje Ishrane?", ru: "Что такое контроль питания?" },
    "Nutrition tracking is the missing half of every training plan that actually works. I build a personalized macro and meal framework around your bodyweight, training load and lifestyle \u2014 protein, carbs, fats, calories, hydration, supplements \u2014 and then we check in weekly: photos, scale, measurements, energy, sleep. We adjust based on real data, not guesses. No restrictive diets, no buzzwords \u2014 just a sustainable food strategy that turns your training into visible, lasting body composition change.": { tr: "Beslenme takibi, gerçekten işe yarayan her antrenman planının görmezden gelinen yarısıdır. Vücut ağırlığın, antrenman yükün ve yaşam tarzına göre kişiye özel bir makro ve öğün çerçevesi (protein, karbonhidrat, yağ, kalori, su, takviyeler) hazırlıyorum; sonra haftalık olarak takip ediyoruz: fotoğraf, tartı, ölçü, enerji, uyku. Tahminlere değil, gerçek verilere göre ayarlama yapıyoruz. Kısıtlayıcı diyet yok, modaya uygun terimler yok — sadece antrenmanını görünür ve kalıcı bir vücut kompozisyonu değişimine dönüştüren sürdürülebilir bir beslenme stratejisi.", sr: "Praćenje ishrane je nedostajuća polovina svakog trening plana koji zaista radi. Pravim personalizovan makro i obrok plan oko tvoje težine, trening opterećenja i životnog stila — proteini, ugljeni hidrati, masti, kalorije, hidracija, suplementi — i onda se nedeljno čekiramo: fotografije, vaga, mere, energija, san. Podešavamo na osnovu stvarnih podataka, ne nagađanja. Bez restriktivnih dijeta, bez buzzword-a — samo održiva strategija ishrane koja tvoj trening pretvara u vidljivu, trajnu promenu telesne kompozicije.", ru: "Контроль питания — это недостающая половина каждого тренировочного плана, который реально работает. Я строю персональный макро- и план питания вокруг твоего веса, нагрузок и образа жизни — белки, углеводы, жиры, калории, гидратация, добавки — и затем мы созваниваемся каждую неделю: фото, весы, замеры, энергия, сон. Корректируем на реальных данных, а не догадках. Никаких ограничительных диет, никаких баззвордов — только устойчивая стратегия питания, которая превращает твои тренировки в видимое и стойкое изменение состава тела." },
    "MACROS BUILT AROUND YOUR BODY:": { tr: "VÜCUDUNA ÖZEL MAKROLAR:", sr: "MAKROI NAPRAVLJENI ZA TVOJE TELO:", ru: "МАКРОСЫ ПОД ТВОЁ ТЕЛО:" },
    "Personalized protein, carb and fat targets calculated from your bodyweight, training volume and goals \u2014 not a generic calculator. Every gram has a job: muscle, recovery, performance or fat loss.": { tr: "Vücut ağırlığın, antrenman hacmin ve hedeflerinden hesaplanmış kişiye özel protein, karbonhidrat ve yağ hedefleri — genel bir hesaplayıcı değil. Her gramın bir işi var: kas, toparlanma, performans ya da yağ kaybı.", sr: "Personalizovani ciljevi proteina, ugljenih hidrata i masti izračunati iz tvoje težine, obima treninga i ciljeva — ne generički kalkulator. Svaki gram ima svoju ulogu: mišić, oporavak, performans ili gubitak masti.", ru: "Персональные цели по белку, углеводам и жирам, рассчитанные исходя из веса, объёма тренировок и целей — не из общего калькулятора. У каждого грамма есть работа: мышца, восстановление, перформанс или жиросжигание." },
    "WEEKLY CHECK-INS, REAL ADJUSTMENTS:": { tr: "HAFTALIK KONTROLLER, GERÇEK AYARLAMALAR:", sr: "NEDELJNI ČEKAPI, STVARNA PODEŠAVANJA:", ru: "ЕЖЕНЕДЕЛЬНЫЕ ЧЕК-ИНЫ, РЕАЛЬНЫЕ КОРРЕКТИРОВКИ:" },
    "Each week we review photos, scale, measurements, energy, sleep and training output. Plateaus get fixed before they stick. The plan evolves with you \u2014 not the other way around.": { tr: "Her hafta fotoğrafları, tartıyı, ölçüleri, enerjiyi, uykuyu ve antrenman çıktısını gözden geçiriyoruz. Platolar kalıcı hale gelmeden çözülür. Plan seninle birlikte evrimleşir — tersi değil.", sr: "Svake nedelje pregledamo fotografije, vagu, mere, energiju, san i trening output. Platoi se rešavaju pre nego što se uvuku. Plan se razvija sa tobom — ne obrnuto.", ru: "Каждую неделю мы смотрим фото, весы, замеры, энергию, сон и результаты тренировок. Плато решаются до того, как они закрепляются. План развивается вместе с тобой — а не наоборот." },
    "FAT LOSS WITHOUT MUSCLE LOSS:": { tr: "KAS KAYBETMEDEN YAĞ KAYBI:", sr: "GUBITAK MASTI BEZ GUBITKA MIŠIĆA:", ru: "ЖИРОСЖИГАНИЕ БЕЗ ПОТЕРИ МЫШЦ:" },
    "Smart deficit periodization protects the muscle you have worked hard to build. You lose fat and keep your strength, your shape and your metabolism \u2014 instead of bouncing back two months later.": { tr: "Akıllı kalori açığı periyodizasyonu, zor kazandığın kası korur. Yağ kaybedersin ama gücünü, formunu ve metabolizmanı korursun — iki ay sonra geri yağ almak yerine.", sr: "Pametna periodizacija kalorijskog deficita štiti mišić koji si mukotrpno gradio. Gubiš mast a zadržavaš snagu, formu i metabolizam — umesto da se dva meseca kasnije sve vrati.", ru: "Грамотная периодизация дефицита защищает мышцы, на которые ты потратил годы. Ты теряешь жир и сохраняешь силу, форму и метаболизм — вместо того чтобы откатиться через два месяца." },
    "A FOOD APPROACH YOU CAN KEEP FOREVER:": { tr: "ÖMÜR BOYU SÜRDÜRÜLEBİLİR BİR YAKLAŞIM:", sr: "PRISTUP HRANI KOJI MOŽEŠ ZADRŽATI ZAUVEK:", ru: "ПОДХОД К ЕДЕ, КОТОРЫЙ МОЖНО СОХРАНИТЬ НАВСЕГДА:" },
    "No off-limits foods, no juice cleanses, no fad protocols. Just a flexible framework that fits your kitchen, your social life and your schedule \u2014 so the result actually lasts beyond the program.": { tr: "Yasaklı yiyecek yok, detoks suyu yok, modaya uygun protokol yok. Sadece mutfağına, sosyal hayatına ve takvimine uyan esnek bir çerçeve — böylece sonuç program bittikten sonra da devam eder.", sr: "Bez zabranjene hrane, bez sok-detoksa, bez modnih protokola. Samo fleksibilan okvir koji se uklapa u tvoju kuhinju, društveni život i raspored — tako da rezultat ostaje i posle programa.", ru: "Нет запрещённых продуктов, никаких сокопостов, никаких модных протоколов. Просто гибкая система, которая подходит твоей кухне, твоей социальной жизни и расписанию — чтобы результат сохранялся и после программы." },
    "Form Check | Eylem Tarhan Personal Training": { tr: "Form Check | Eylem Tarhan Kişisel Antrenman", sr: "Form Check | Eylem Tarhan Personal Training", ru: "Form Check | Eylem Tarhan Personal Training" },
    "FORM CHECK": { tr: "FORM CHECK", sr: "FORM CHECK", ru: "FORM CHECK" },
    "What is a Form Check?": { tr: "Form Check Nedir?", sr: "Šta je Form Check?", ru: "Что такое Form Check?" },
    "Form check is the single fastest way to upgrade your training \u2014 you film a working set, send it in, and within 24 hours you get a frame-by-frame breakdown: what is working, what is quietly stealing your gains, and the exact cues to fix it. Squat, deadlift, bench, overhead press, pull-up, kettlebell swing \u2014 any lift, any level. Perfect for self-trained lifters, online clients, or anyone who has been stuck on a plateau and is not sure why.": { tr: "Form check, antrenmanını en hızlı şekilde bir üst seviyeye taşıyan tek pratik yöntemdir — bir set videosunu gönderiyorsun, 24 saat içinde kare kare analiz alıyorsun: neler doğru gidiyor, neler ilerlemeni sessizce engelliyor ve düzeltmek için tam olarak hangi ipuçlarına odaklanman gerekiyor. Squat, deadlift, bench press, omuz pressi, pull-up, kettlebell swing — hangi hareket, hangi seviye olursa olsun. Kendi başına çalışan, online danışan veya nedeni belirsiz bir platoda takılan herkes için ideal.", sr: "Form check je najbrži način da unaprediš trening — snimiš radnu seriju, pošalješ je, i u roku od 24h dobiješ analizu kadar po kadar: šta radi, šta ti tiho krade napredak i tačno koje cue-ove trebaš da to popraviš. Čučanj, mrtvo dizanje, potisak, OHP, zgib, kettlebell swing — bilo koji lift, bilo koji nivo. Idealno za one koji treniraju sami, online klijente ili svakoga ko zaglavi na platou a ne zna zašto.", ru: "Form Check — самый быстрый способ улучшить тренировку: ты снимаешь рабочий подход, отправляешь, и в течение 24 часов получаешь покадровый разбор: что работает, что тихо крадёт прогресс, и точные подсказки, как починить. Присед, становая, жим, OHP, подтягивание, мах гирей — любое движение, любой уровень. Идеально для тех, кто тренируется один, онлайн-клиентов или любого, кто застрял на плато и не понимает почему." },
    "INSTANT FEEDBACK ON YOUR LIFTS:": { tr: "HAREKETLERİNE ANINDA GERİBİLDİRİM:", sr: "TRENUTAN FEEDBACK NA TVOJE LIFTOVE:", ru: "МГНОВЕННЫЙ ФИДБЭК ПО ТВОИМ ПОДХОДАМ:" },
    "A clear, written breakdown plus annotated screenshots within 24 hours. No vague platitudes, no \"looks good keep going\" \u2014 exact cues, exact fixes, exact next steps for your next session.": { tr: "24 saat içinde net, yazılı analiz ve işaretli ekran görüntüleri. Belirsiz klişe yok, \"iyi gidiyorsun devam\" yok — tam ipuçları, tam düzeltmeler, bir sonraki seansın için tam adımlar.", sr: "Jasna, pisana analiza plus označeni screenshot-ovi u roku od 24h. Bez maglovitih fraza, bez \"izgleda dobro, samo nastavi\" — tačni cue-ovi, tačna rešenja, tačni sledeći koraci za sledeći trening.", ru: "Чёткий письменный разбор и скриншоты с пометками в течение 24 часов. Никаких туманных фраз, никаких \"выглядит хорошо, продолжай\" — точные подсказки, точные исправления, точные шаги к следующей тренировке." },
    "INJURY-PROOF YOUR TECHNIQUE:": { tr: "TEKNİĞİNİ SAKATLIKTAN KORU:", sr: "ZAŠTITI TEHNIKU OD POVREDA:", ru: "ЗАЩИТИ ТЕХНИКУ ОТ ТРАВМ:" },
    "Bad form does not announce itself; it shows up as a tweaked back two years later. Catching small leaks early \u2014 knee tracking, hip shift, bar path, bracing \u2014 saves you from the injuries that derail real progress.": { tr: "Kötü form kendini önceden duyurmaz; iki yıl sonra çekilmiş bir bel olarak ortaya çıkar. Küçük kaçakları erken yakalamak — diz hizalaması, kalça kayması, bar yolu, ısrar — gerçek ilerlemeni rayından çıkaran sakatlıklardan korur.", sr: "Loša forma ne najavljuje sebe; pojavi se kao istegnuta leđa dve godine kasnije. Hvatanje sitnih curenja na vreme — praćenje kolena, pomak kuka, putanja šipke, bracing — štiti te od povreda koje stvarno zaustavljaju napredak.", ru: "Плохая техника себя не выдаёт сразу; она проявляется через два года растянутой спиной. Поймать мелкие утечки на ранней стадии — траектория коленей, смещение бёдер, путь грифа, брейсинг — спасает от травм, которые рушат реальный прогресс." },
    "BREAK THROUGH PLATEAUS:": { tr: "PLATOLARI AŞ:", sr: "PROBIJ PLATOE:", ru: "ПРОБЕЙ ПЛАТО:" },
    "When the bar will not move, technique is almost always the missing piece. A single form fix often unlocks 20\u201330% more strength on a stuck lift \u2014 without changing your program at all.": { tr: "Bar yerinden kımıldamadığında, eksik parça neredeyse her zaman tekniktir. Tek bir form düzeltmesi, takılan bir harekette %20–30 daha fazla güç açar — programını değiştirmek bile gerekmez.", sr: "Kad šipka neće da krene, tehnika je skoro uvek deo koji nedostaje. Jedna ispravka forme često otključava 20–30% više snage na zaglavljenom liftu — bez ikakve promene programa.", ru: "Когда штанга не идёт, техника почти всегда — недостающий элемент. Одна правка формы часто открывает на 20–30% больше силы на застрявшем подъёме — без всяких изменений в программе." },
    "PROGRESS WITHOUT A TRAINER PRESENT:": { tr: "ANTRENÖR YANINDA OLMADAN İLERLE:", sr: "NAPREDUJ I BEZ TRENERA UŽIVO:", ru: "ПРОГРЕСС БЕЗ ТРЕНЕРА РЯДОМ:" },
    "Built for online clients, traveling lifters and anyone who trains solo. Get expert eyes on every working set, week after week, even when we are not in the same gym together.": { tr: "Online danışanlar, seyahatte antrenman yapanlar ve tek başına çalışan herkes için tasarlandı. Aynı salonda olmasak da uzman gözünü her çalışma setine, hafta hafta uygula.", sr: "Napravljeno za online klijente, lifter-e u pokretu i sve koji treniraju sami. Imaj stručno oko na svakoj radnoj seriji, nedelju za nedeljom, čak i kad nismo u istoj teretani.", ru: "Создано для онлайн-клиентов, путешествующих атлетов и всех, кто тренируется в одиночку. Получай экспертный взгляд на каждый рабочий подход, неделя за неделей, даже когда мы не в одном зале." },
